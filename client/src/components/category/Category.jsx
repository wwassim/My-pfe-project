...
const Category = ({filterCategory}) => {
  return (
    ...
    <div className='grid grid-cols-2 md:grid-cols-4 gap-6 py-6'>
            ...
            <div  className='bg-white rounded-lg p-4 flex justify-between items-center cursor-pointer' onClick={()=>filterCategory("Sport")}>
            ...
            <div  className='bg-white rounded-lg p-4 flex justify-between items-center cursor-pointer' onClick={()=>filterCategory("Education")}>
